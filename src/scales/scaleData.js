// Scale data (interval tables for every scale family), the precomputed-chord
// cache built from it, and getScaleNotes (root + intervals -> spelled note
// names). Framework-free except for reading the theory/notation scale-
// spelling context - no DOM here. `getScaleFromId` stays module-private,
// used only by `precomputeScaleChords` internally; grepping all of src/
// found zero external importers of it despite it being exported before
// this move.
//
