...
import { createChordElement } from './progression/chordCard';
...
export {
    ...
    // Cross-imported back by src/progression/scaleSync.js and
    // src/progression/chordCard.js - see those files' headers for why
    // (neither has moved out of this file yet).
    precomputeAllPatternData,
    updateProgressionDisplay
};
